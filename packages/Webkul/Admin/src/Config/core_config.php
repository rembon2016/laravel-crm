    ...
    [
        ...
        'fields' => [
            [
                ...
                'type'       => 'editor',
                'default'    => 'Powered by <span style="color: rgb(14, 144, 217);"><a href="http://www.rembon.com" target="_blank">Rembon</a></span>, an open-source project by <span style="color: rgb(14, 144, 217);"><a href="https://rembon.com" target="_blank">RKD</a></span>.',
                'tinymce'    => true,
            ],
        ],
    ], [
        ...
        'fields' => [
            [
                ...
                'name'       => 'contacts.persons.persons',
                'title'      => 'admin::app.configuration.index.general.settings.menu.persons',
                'type'       => 'text',
                'default'    => 'Persons',
                'validation' => 'max:20',
            ], [
                'name'       => 'contacts.organizations.organizations',
